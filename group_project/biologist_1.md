...
Summary: The PTSD Blood Transcriptome Mega-Analysis combined peripheral blood gene-expression data from five independent studies, encompassing 229 individuals with PTSD and 311 trauma-exposed controls, to identify biologically meaningful and reproducible molecular signatures of PTSD. By integrating datasets across diverse trauma types, sexes, and platforms, the authors overcame the inconsistency and low statistical power that have limited prior transcriptomic studies. Although no single gene reached study-wide significance after strict multiple-testing correction, the mega-analysis revealed coherent patterns of immune and inflammatory pathway dysregulation, particularly enrichment of type I interferon signaling, antiviral response genes, and innate immune activation. Key candidate genes showing consistent differential expression across specific subsets included IFIT3, IFI44L, GNG11, and several interferon-stimulated genes (such as DDX58, IFIH1, IFIT1/2, MX1, RSAD2, STAT1, and OAS-family genes). Co-expression network analyses further demonstrated that PTSD is associated with coordinated shifts in immune-related gene modules, suggesting that the disorder involves systemic biological changes extending beyond the central nervous system. Together, these results provide stronger evidence for an immune-inflammatory component to PTSD, highlight molecular pathways that may underlie vulnerability or symptom maintenance, and illustrate how large-scale integrated analyses can improve reproducibility and identify emerging blood-based biomarkers for psychiatric disorders.
